...
namespace Bookcrossing.Data.Repositories.Interface
{
        ...
        where TEntity : IIdentifiable<Guid>, ISoftDeleteable
    {
        ...
        Task<IReadOnlyCollection<TEntity>> GetAsync(ParametersBase pagination, CancellationToken ct = default);
        ...
        Task<IReadOnlyCollection<TEntity>> GetByCondition(Expression<Func<TEntity, bool>> expression, ParametersBase parameters, CancellationToken ct = default);
