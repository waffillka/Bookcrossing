...
namespace Bookcrossing.Application.Queries.Publisher
{
    ...
    public class GetPublisherByIdHandler : BaseRequestHandler<GetPublisherById, PublisherDeteilsDto>
    {
        ...
        {
            var entity = await _publisherRepository.GetOneByCondition(x => x.Id == request.PublisherId);
